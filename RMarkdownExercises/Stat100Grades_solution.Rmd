...
**Now add the bonus points to the weighted total according to the formula stated on the <a href="http://courses.las.illinois.edu/stat/stat100/grade.html" target="_blank">Stat 100 Grading webpage</a>:**
...
We're going to use Method 3 on <a href="http://go.illinois.edu/stat390/grade_assignment.html" target="_blank">this page</a>. First, create the vectors `break_pts` and `grades` in accord with the grade table. Then use the `cut()` function to assign grades. 
```{r}
