...
```{r}
# Reset "M" to the reference level for the 'Gender' factor:
galton$Gender <- relevel(galton$Gender, ref="M")
...
<hr />
**Aside**: After "transmuted" the female heights, we no longer see the two clusters of points. When we color-code the gender in the residual plot, male and female points are mixed together:
```{r}
