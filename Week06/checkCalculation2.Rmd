...
First load the data file you are asked to analyze. For this demonstration, we assume that the data file is http://courses.atlas.illinois.edu/spring2016/STAT/STAT200/RProgramming/data/world_cities/cities009.csv. We load it using the command 
```{r, eval=FALSE}
cities <- read.csv("http://courses.atlas.illinois.edu/spring2016/STAT/STAT200/RProgramming/data/world_cities/cities009.csv", as.is=TRUE)
```
The `as.is=TRUE` is an option telling R not to convert strings to factors. 
```{r, echo=FALSE}
# download from the computer instead
